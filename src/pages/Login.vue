  ...
  <div class="login wh100 flex flex-vcenter">
      <div class="login-page margin-center">
        <el-container>
            ...
            <el-main>
                <div class="main">
                    <p class="title align-l">Amber的ElementUI后台管理系统</p>
                    <div class="form-data">
                        <el-form  ref="loginForm" :rules="rules" label-position="left"  label-width="80px" :model="formLabel">
                            <el-form-item label="账号" prop="account">
                                <el-input type="email" v-model="formLabel.account" placeholder="请输入邮箱" clearable></el-input>
                            </el-form-item>
                            <el-form-item label="密码" prop="pwd">
                                <el-input type="password" v-model="formLabel.pwd" auto-complete="off" placeholder="请输入密码" clearable></el-input>
                            </el-form-item>
                            <el-form-item label="确认密码" prop="aPwd" v-show="againPwdVisible">
                                <el-input type="password" v-model="formLabel.aPwd" auto-complete="off" placeholder="请确认密码" clearable></el-input>
                            </el-form-item>
                            <el-form-item>
                                <el-button type="primary" @click="addReg('loginForm')">注册</el-button>
                                <el-button @click="addLogin('loginForm')">登录</el-button>
                            </el-form-item>
                        </el-form>
                    </div>
                </div>
...
export default {
  data() {
    ...
    // 确认密码自定义校验
    var aPwd = (rule, value, callback) => {
      if (!value) {
        return callback(new Error("确认密码不能为空"));
      } else if (!/^[a-zA-Z0-9]{3,8}$/.test(value)) {
        return callback(new Error("确认密码为3-8位的字母或数字"));
      } else if (this.formLabel.aPwd !== this.formLabel.pwd) {
    ...
    return {
      ...
      rules2: {
        account: [{ validator: account, trigger: "blur" }],
        pwd: [{ validator: pwd, trigger: "blur" }],
        aPwd: [{ validator: aPwd, trigger: "blur" }]
      },
      rules: {}
    };
  },
